...
@section('content')
  ...
  <section class="content ">
    <ul class="products">
      @foreach ($sciarpes as $sciarpe)
        <li>
          <div class="product-card">
            <span class="product-info">
              <h3>{{ $sciarpe->product_name }}</h3>
            </span>
            <span class="icon-square">
              <a href="{{ URL::route('products.single', ['products'=>$sciarpe->id]) }}">
                 <img data-src="{{ URL::to('/public/icons/icon_object_01.svg') }}" alt="vai avanti" width="28px" height="28px">
              </a>
            </span>
            <div class="product-image">
              <img data-src="{{ URL::to('/public/images/product-feature/'.$sciarpe->product_preview) }}" alt="{{$sciarpe->product_name}}" width="100%" height="100%">
            </div>
          </div>
        </li>
      @endforeach
