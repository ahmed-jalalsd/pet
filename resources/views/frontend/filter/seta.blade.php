...
@section('content')
        ...
        <li>
          <div class="product-card">
            <span class="product-info">
              <h3>{{ $seta->product_name }}</h3>
            </span>
            <span class="icon-square">
              <a href="{{ URL::route('products.single', ['products'=>$seta->id]) }}">
                 <img data-src="{{ URL::to('/public/icons/icon_object_01.svg') }}" alt="vai avanti" width="28px" height="28px">
              </a>
            </span>
            <div class="product-image">
              <img data-src="{{ URL::to('/public/images/product-feature/'.$seta->product_preview) }}" alt="{{$seta->product_name}}" width="100%" height="100%">
            </div>
          </div>
        </li>
      @endforeach
  ...
  <div class="filter-menu">
    <span class="icon-close">
      <img src="{{URL::to('/icons/icon_object_01.svg')}}" alt="">
    </span>
    <ul>
      <li class="setting">
