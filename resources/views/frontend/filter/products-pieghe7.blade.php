...
@section('content')
  ...
  <section class="content ">
    <ul class="products">
      @foreach ($pieghes7 as $pieghe7)
        <li>
          <div class="product-card">
            <span class="product-info">
              <h3>{{ $pieghe7->product_name }}</h3>
            </span>
            <span class="icon-square">
              <a href="{{ URL::route('products.single', ['products'=>$pieghe7->id]) }}">
                 <img data-src="{{ URL::to('/public/icons/icon_object_01.svg') }}" alt="vai avanti icon" width="28px" height="28px">
              </a>
            </span>
            <div class="product-image">
              <img data-src="{{ URL::to('/public/images/product-feature/'.$pieghe7->product_preview) }}" alt="{{ $pieghe7->product_name }}" width="100%" height="100%">
            </div>
          </div>
        </li>
      @endforeach
