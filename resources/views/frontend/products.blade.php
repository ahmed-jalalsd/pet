        ...
        <li>
          <div class="product-card">
            ...
            <span class="icon-square">
              <a href="{{ URL::route('products.single', ['products'=>$product->id]) }}">
                 <img data-src="{{ URL::to('/public/icons/icon_object_01.svg') }}" alt="vai avanti icon" width="28px" height="28px">
              </a>
            </span>
            <div class="product-image">
              <a href="{{ URL::route('products.single', ['products'=>$product->id]) }}">
                <img data-src="{{ URL::to('/public/images/product-feature/'.$product->product_preview) }}" alt="{{ $product->product_name }}" width="100%" height="100%">
              </a>
            </div>
          </div>
        </li>
